...
from flask_smorest import Blueprint, abort, jwt_required
...
@blp.route("/wallet/<string:username>")
class Wallet(MethodView):
    ...
    def get(self, username):
        ...
        wallet_amount = order_controller.get_wallet(username)
        if wallet_amount:
            return {
                "email":username,
